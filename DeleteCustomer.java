...
class DeleteCustomer extends Frame implements WindowListener,ActionListener{
	...
	public DeleteCustomer(Register r){
	...
	public void actionPerformed(ActionEvent e){
		...
		if(st.equals("confirm")){
			...
			String sql1="delete from customer WHERE `log_id` = '"+user+"'";
			da.updateDB(sql1);
			...
			register.dltc.setVisible(false);
